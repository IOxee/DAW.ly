...
<!--
<link rel="stylesheet" type="text/css" media="screen" href="<?= base_url('explorer-themes/windows-10/css/theme.css') ?>">
-->
...
<script>
    define('elFinderConfig', {
        ...
        defaultOpts: {
            url: '<?php echo base_url('/fileconnector') ?>', // connector URL (REQUIRED)
            height: screen.availHeight / 1.10,
            width: screen.availWidth / 1.25,
            commandsOptions: {
                edit: {
                    extraOptions: {
...
<div class="container" id="elfinder"></div>
